...
//             <div
//               data-active={isDataActive}
//               className="text-muted-foreground data-[active=true]:text-secondary-foreground mt-0 line-clamp-2 min-h-[3em] pt-0 break-all text-ellipsis whitespace-break-spaces"
//             >
...
//               <span
//                 data-active={isDataActive}
//                 className="text-muted-foreground/80 data-[active=true]:text-secondary-foreground text-xs select-none"
//               >
...
//                     <span
//                       data-active={isDataActive}
//                       className="data-[active=true]:text-secondary-foreground cursor-default text-xs text-blue-400/80 select-none"
//                     >
